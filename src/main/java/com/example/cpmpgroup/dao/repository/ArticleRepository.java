...
import com.example.cpmpgroup.dao.models.Article;
...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,au.prix,au.quantitee,t.id,t.typeLib) FROM Article a JOIN a.bcassociation au join a.type t where au.id.bondecommande_id = :bcId")
    public List<ArticleDTO> getArticlesUtilisees(@Param("bcId") long bcId);


    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id,a.code,a.designation,a.unitee,a.classe,t.id,t.typeLib) FROM Article  a join a.type t")
    public List<ArticleDTO> getAllArticlesJoins();

    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id,a.code,a.designation,a.unitee,a.classe, t.id,t.typeLib) FROM Article a join  a.type t join t.metier m where m.id= :metierId")
    ...
    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,sum (at.quantiteeRealisee),t.id,t.typeLib) FROM Article a JOIN a.articlesAttachees at join a.type t where at.attachement.bonDeCommande.id = :bcId and a.classe='prestation' group by a")
    ...
    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,sum (at.quantiteeRealisee),t.id,t.typeLib) FROM Article a JOIN a.articlesAttachees at join a.type t where at.attachement.bonDeCommande.id = :bcId and a.classe='materielFournisseur' group by a")
    public List<ArticleDTO> getArticlesRealiseesMFGlobalbyBC(@Param("bcId") long bcId);

    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,mb.prix,mb.quantiteeLivree,t.id,t.typeLib) FROM Article a JOIN a.materielsBCdeProjet mb join a.type t where mb.bonLivraisonProjet.bl_id = :blId and a.classe='materiel En Regie'")
    public List<ArticleDTO> getMaterielsByBLdeProjet(@Param("blId") long blId);

    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,mo.prix,mo.quantiteeLivreeMC,t.id,t.typeLib) FROM Article a JOIN a.materielsBCdeMC mo join a.type t where mo.bonLivraisonMC.id = :blId and a.classe='materiel En Regie'")
    ...
    @Query("SELECT new com.example.cpmpgroup.dao.dto.ArticleDTO(a.id, a.code,a.designation,a.unitee,sum (at.quantiteeRealisee),t.id,t.typeLib) FROM Article a JOIN a.articlesAttachees at join a.type t where at.attachement.bonDeCommande.id = :bcId and a.classe='materiel En Regie' group by a")
